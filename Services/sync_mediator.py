...
class SyncMediator(ISyncMediator):
    ...
    def run_two_way_sync(self):
        ...
        google_events_by_id = {google_event.google_event_id: google_event for google_event in google_changes if google_event.google_event_id}
        local_events_by_google_id = {local_event.google_event_id: local_event for local_event in local_changes if local_event.google_event_id}
    ...
    def _process_google_event(self, google_id: str, google_event: EventDTO, local_events_by_google_id: dict, sync_time: datetime.datetime):
